---
name: veritas-investigator
description: >-
  Use when investigating a dataset with the Veritas MCP server — building a hypothesis
  tree, falsifying branches with run_sql/run_python, running the discovery pass, and
  reporting only numbers that trace to a verified execution. Teaches the
  receipts-or-it-didn't-happen workflow and the phrasing that makes verify_finding pass.
---
